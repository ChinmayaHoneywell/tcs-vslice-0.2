...
object CommandHandlerActor {
  def createObject(commandResponseManager: CommandResponseManager,
    ...
    Behaviors.setup(ctx => CommandHandlerActor(ctx, commandResponseManager, lifeCycleActor, zeroMQProtoActor, loggerFactory))
}
/*
    ...
    immediateCommand.controlCommand.commandName.name match {
      case Commands.FOLLOW => {
        ...
        val followCmdActor: ActorRef[ImmediateCommand] =
          ctx.spawn(FollowCmdActor.create(commandResponseManager, zeroMQProtoActor, loggerFactory), name = "FollowCmdActor")
    ...
    cmdMessage.controlCommand.commandName.name match {
      case Commands.STARTUP => {
        ...
        val startupCmdActor: ActorRef[ControlCommand] =
          ctx.spawn(StartupCmdActor.create(commandResponseManager, zeroMQProtoActor, loggerFactory), "StartupCmdActor")
      ...
      case Commands.SHUTDOWN => {
        ...
        val shutDownCmdActor: ActorRef[ControlCommand] =
          ctx.spawn(ShutdownCmdActor.create(commandResponseManager, zeroMQProtoActor, loggerFactory), "ShutdownCmdActor")
      ...
      case Commands.POINT => {
        ...
        val pointCmdActor: ActorRef[ControlCommand] =
          ctx.spawn(PointCmdActor.create(commandResponseManager, zeroMQProtoActor, loggerFactory), "PointCmdActor")
      ...
      case Commands.POINT_DEMAND => {
        ...
        val pointDemandCmdActor: ActorRef[ControlCommand] =
          ctx.spawn(PointDemandCmdActor.create(commandResponseManager, zeroMQProtoActor, loggerFactory), "PointDemandCmdActor")
      ...
      case Commands.DATUM => {
        ...
        val datumCmdActor: ActorRef[ControlCommand] =
          ctx.spawn(DatumCmdActor.create(commandResponseManager, zeroMQProtoActor, loggerFactory), "DatumCmdActor")
