...
object EventHandlerConstants {
  ...
  val HCD_Event_RECEV_TIME_KEY: Key[Long]      = KeyType.LongKey.make(EventConstants.HCD_EVENT_RECEIVAL_TIME)
  val ASSEMBLY_EVENT_RECEV_TIME_KEY: Key[Long] = KeyType.LongKey.make(EventConstants.ASSEMBLY_EVENT_RECEIVAL_TIME)
